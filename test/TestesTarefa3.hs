module TestesTarefa3 (testesTarefa3) where
...
-- | Jogador centrado em Escada

p1 = Personagem (0.0,0.0) Jogador (0.5,0.5) Este (1,1) False False 10 0 (False, 0.0)

teste7 = "T7: Jogador não está centrado em escada " ~: False ~=? centradoEmEscada gameMap2 p1

teste8 :: Test 
teste8 = "T8: Jogador interage corretamente com o inimigo" ~: j7 ~=? movimenta 100 1.0 j9 
  where 
    pl7 = Personagem (0.0,0.0) Jogador (4,7.6) Oeste (1,1) False False 10 0 (False, 0.0)
    en4 = Personagem (0.0,0.0) Fantasma (2.5,7.6) Este (1,1) False True 10 0 (True, 10.0)
    j9  = Jogo gameMap1 [en4] [] pl6 

testesTarefa3 = test [teste1A, teste1B, teste1C, teste2A, teste2B, teste3, teste4, teste5, teste6, teste7, teste8]
